...
function anxiousstoic_script_enqueue() {
    ...
    */
    wp_enqueue_style(
        'customstyle',
        get_template_directory_uri() . 'css/anxioustoic.css',
        array(),
        '1.0.0',
        'all'
    );
    /*
      Add Bootstrap css.min CDN stylesheet. Last three params usually not needed.
    */
    wp_enqueue_style(
        'bootstrapcss',
        'https://link.to.bootsrap.cdn.from.getbootstrap.com'
    );
    /*
    ...
    */
    wp_enqueue_script(
        'customjs',
        get_template_directory_uri() . 'js/anxioustoic.js',
        array(),
        '1.0.0',
        true
    );
    /*
      Add jQuery and Bootstrap js.min CDN. jQuery is required despite WP having a version available
    */
    wp_enqueue_script(
        'jquery', 
        'https://most.recent.jquery.cdn.from.ajax.googleapis.com/',
        array(), // <-- There we go
        '#.#.#', 
        true
    );
